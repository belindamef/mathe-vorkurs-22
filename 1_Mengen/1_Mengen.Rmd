...
* Es seien $A := \{1\}$, $B := \{1,2\}$, $C := \{1,2\}$. Dann gilt:  
$A \subset B, A \subset C, B \subseteq C, C \subseteq B$ und $B = C$.
...
* Ein Bsp für $x \in \mathbb{R}^4$ ist  $x = \begin{pmatrix} 0.16 \\ 1.76 \\ 0.23 \\ 7.10 \end{pmatrix}$, Ein Bsp für $x \in \mathbb{R}^2$ ist  $x = \begin{pmatrix} 2.81 \\ 4.22 \end{pmatrix}$.
