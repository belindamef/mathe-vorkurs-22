...
\footnotesize
\setstretch{.5}
\begin{theorem}[Rechenregeln für Produkte]
\normalfont
\justifying
\vspace{1mm}
...
\begin{equation}
\left( \prod_{i=1}^n x_i \right) \cdot \left( \prod_{i=1}^n y_i  \right)= \prod_{i=1}^n (x_i \cdot y_i)
\end{equation}

Distributivität bei Multiplikation mit einer Konstante 
\begin{equation}
\prod_{i=1}^n ax_i = a \left(\prod_{i=1}^n x_i \right)
\end{equation}

Aufspalten von Produkten mit $1 < m < n$
\begin{equation}
\prod_{i = 1}^n x_i = \left( \prod_{i=1}^m x_i \right) \cdot \left( \prod_{i=m+1}^n x_i\right) 
\end{equation}
