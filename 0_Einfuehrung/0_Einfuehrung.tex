...
\protect\hypertarget{literaturempfehlungen}{}
...
\begin{frame}{Literaturempfehlungen}
\protect\hypertarget{literaturempfehlungen-1}{}
...
\begin{center}\includegraphics[width=0.3\linewidth]{../Abbildungen/glmi_0_baerwolff} \includegraphics[width=0.3\linewidth]{../Abbildungen/glmi_0_herold} \end{center}
\end{frame}
